(function ($) {
  ...
  Drupal.behaviors.leaflet = {
    attach:function (context, settings) {
      ...
      //console.log('my leaflet_js loaded');
      ...
      $(settings.leaflet).each(function () {
        ...
        **/
        ...
        /**
         * very useful (essential) to bring the features to the global lMap object (and interact with them from outside and after it is loaded in the page),
         * as the same "this.features" objects will be destroyed (here some code rows later) for AJAX view relaod needs (when the View has "Use AJAX" set to Yes).
        **/
        ...
        **/
        ...
        /**
         *Resets the global Drupal.leaflet.bounds array, ready again to be used for next map's features
         *This is needed for correct behaviours with more than one map in the page
         *(otherwise if the previous loaded map sets wider feature bounds, the folowers map will kee that bounds ...   )
         **/
