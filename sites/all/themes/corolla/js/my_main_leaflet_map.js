            ...
            //console.log(this); //Debug
                ...
                if (thisLeafletMap) {
                    ...
                    for (var i = 0; i < thisLeafletMap.features.length; i++) {
                        ...
                        var popuplatlng = new L.LatLng(lat + 0.00060, lng );
                ...
                $(".block-most-ranked .views-row a.map-zoom").bind('mouseover', function(event) {
                ...
                $(".block-most-ranked .views-row a.map-zoom").bind('mouseout', function(event) {
...
Drupal.company_sites_map = {
    ...
    zoomToFeature: function (map, feature) {    
        ...
        map.setView([parseFloat(feature.lat), parseFloat(feature.lon)], 14, false).whenReady( function () {
            setTimeout( function () {
